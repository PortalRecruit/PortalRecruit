        ...
        if query and st.session_state.get("search_requested"):
            ...
            if not play_ids:
                ...
                for pid, desc, gid, clock, player_id, player_name in play_rows:
                    ...
                    # 2. Dynamic Overrides based on User Intent
                    ...
                    # Fallback reason if nothing matched intents specifically
                    if not reason_parts:
                        # Pick their #1 strength
                        if strengths:
                             reason_parts.append(f"elite {strengths[0].lower()}")
                        else:
